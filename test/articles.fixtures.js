function makeArticlesArray() {
    return [
        //used string as date type instead of new Date(datestring) like articlesservice.getAllArticles
        {
            id: 1,
...
module.exports = {makeArticlesArray} //whats the difference between 
//makerArticlesArray and {makerArticlesArray}????????